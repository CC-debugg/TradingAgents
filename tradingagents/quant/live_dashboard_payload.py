...
def build_live_payload(
    ...
    return {
        ...
        "research_refs": [
            ...
            {
                "id": "kelly_xiu_2023",
                "cite": "Kelly & Xiu — Financial Machine Learning (SSRN 4501707)",
                "pdf": "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4501707",
                "use": "ML methodology survey · rl_tensortrade research sleeve",
            },
            {
                "id": "tensortrade",
                "cite": "TensorTrade — open-source RL trading framework (Apache 2.0)",
                "pdf": "https://github.com/tensortrade-org/tensortrade",
                "use": "rl_tensortrade offline training env (py3.12, research only)",
            },
            {
                "id": "lopez_de_prado_afml",
                "cite": "Lopez de Prado — Advances in Financial ML ch.7 (purged CV)",
                "pdf": "MLFinLab methods re-implemented (library is closed-source)",
                "use": "strategy_audit purged walk-forward with embargo",
            },
            {
                "id": "fincept",
                "cite": "Fincept Terminal — 100+ market/macro data connectors (AGPL-3.0)",
                "pdf": "https://github.com/Fincept-Corporation/FinceptTerminal",
                "use": "connector catalog reference for macro regime inputs (not vendored)",
            },
        ],
